...
import { SyncOutlined, StarOutlined, UserOutlined} from '@ant-design/icons';
...
export default class ReceiveTaskList extends React.Component{
    constructor(props){
        super(props);
    ...
    componentWillMount(){
        ...
        let address = server + "/tasklist/receivelist";
        var temp = []
            ...
            <div>
                ...
                <List
                    ...
                    >
                        ...
                        <br/>
                        <div>
                        <Tag style={{height:"25px",fontSize:"12px",textAlign:"center"}} icon={<SyncOutlined spin />} color="processing">
                            已领取
                        </Tag>
                        </div>
                    </List.Item>
