...
import {Popconfirm,Image,Button,Tag,Avatar,List} from 'antd'
...
export default class UserPostTask extends React.Component{
    constructor(props){
        super(props);
    ...
    componentWillMount(){
        ...
        let address = server + "/usertask/postinfo/" +localStorage.getItem("user") ;
        var temp = []
    ...
    handleOk = (e) =>{
        console.log("eeee : ",e)
        let address = server + "/user/task/delete";
        this.setState({
            loading:true
        })
